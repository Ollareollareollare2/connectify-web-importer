  ...
  return (
    <section id="join" className="py-24 px-4 md:px-6 relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-display font-bold mb-6">Pronto a Unirti all'Élite?</h2>
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Fai parte della community italiana più esclusiva di Pokémon competitivo e porta il tuo gioco al livello successivo. Unisciti a Judgment Fleet oggi!
          </p>
          ...
          <div className="mt-8 text-gray-400">
            <p>Già membro? Accedi al tuo account</p>
          </div>
        </motion.div>
      </div>
    </section>
